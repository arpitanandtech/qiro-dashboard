...
const Chip = ({ isSecondary, onClick, isGrey, isSmall, isFull, isTrans, isImg, img, title, isPrimary, isNot, noti, isNotLeft }: { isNotLeft?: boolean, isSecondary?: boolean, onClick?: () => void, isGrey?: boolean, isSmall?: boolean, isFull?: boolean, isTrans?: boolean, isNot?: boolean, noti?: React.ReactNode, isImg?: boolean, img?: string, isPrimary?: boolean, title: string }) => {
  return (
